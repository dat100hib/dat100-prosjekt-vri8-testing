...
Prosjektet handler om å implementation av kort spillet vri åtter i Java med fokus på implementasjon av de sentrale datastrukturer og logikk som ligger bak en spill-applikasjon. 
...
## Programmeringsoppgaver (TO BE UPDATED)
